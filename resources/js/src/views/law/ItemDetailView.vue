        ...
        <div class="item-content">
          ...
          <div class="product-details p-6">
            <div class="vx-row mt-6">
              <div class="vx-col md:w-2/5 w-full flex">
                <div class="product-img-container mx-auto mb-10 md:mb-0">
                  <img :src="item_data.image_url" :alt="item_data.name" class="responsive">
              ...
              <div class="vx-col md:w-3/5 w-full">
                ...
                <p class="my-2">
                  <span>{{ item_data.address }}</span>
                </p>
                <p class="flex items-center flex-wrap">
                  <span class="text-2xl leading-none font-medium text-primary mr-4 mt-2">{{ item_data.price | formatCurrency}}</span>
                ...
                <vs-divider />
                  <div v-html="item_data.description"></div>
                <vs-divider />

                <!-- Color -->
                <div class="vx-row">
                  <div class="vx-col w-full">
                    <span class="text-xl font-medium">Lĩnh vực hành nghề</span>
                    <div class="vs-row mt-3">
                      <div class="vs-col vs-sm-6 vs-lg-4 mb-3 pr-3"  v-for="type in item_data.arr_law_type">
                          <span class="flex items-center">
                            <feather-icon icon="CheckSquareIcon" svgClasses="h-6 w-6" :class="'text-'+type.color" class="mr-2" />
                ...
                <div class="vx-row">
                  <div class="vx-col w-full">
                    <span class="text-xl font-medium">Chứng chỉ bằng cấp</span>
                    <div class="vs-row mt-3">
                     <swiper :options="swiperOptionCertificate" :dir="$vs.rtl ? 'rtl' : 'ltr'" :key="$vs.rtl">
                        <swiper-slide>
                          <img class="responsive" src="https://i-law.vn/uploads/users/234/nguyentam.jpg" alt="banner">
                        </swiper-slide>
                        <swiper-slide>
                          <img class="responsive" src="https://i-law.vn/uploads/users/234/ls-nguyen-tam.jpg" alt="banner">
                        </swiper-slide>
                        <swiper-slide>
                          <img class="responsive" src="https://i-law.vn/uploads/users/234/nguyen-tam.jpg" alt="banner">
                        </swiper-slide>
                  ...
                  <div class="vx-col w-full">
                    <div class="flex flex-wrap items-start mb-4">
                      ...
                      <vs-button
                        ...
                        icon-pack="feather"
                        icon="icon-shopping-cart"
                        @click="$router.push({name: 'law-checkout'}).catch(err => {})">
                        VIEW IN CART
                      </vs-button>
                      <!-- /Add To Cart Button -->
...
export default{
  ...
  methods: {
    ...
    fetch_item_details (id) {
      this.$http.post('/api/law/item/detail', { 'id' : id })
      .then((response) => { this.item_data = response.data ; })
